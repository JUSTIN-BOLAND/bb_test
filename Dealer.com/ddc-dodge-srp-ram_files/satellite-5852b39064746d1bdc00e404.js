_satellite.pushAsyncScript(function(event, target, $variables){
  ...
  var winS = window.location.search;
	if(winS && winS.indexOf('showroom_lead') >= 0){
		var dID = "unset";
    ...
    var av3 = "";
		...
		var b = "https://a01.korrelate.net/a/e/d2a.ads?r="+cb+"&et=a&ago=447&ao=513&px=377&pt=s&lvl=nomodel&av1=shwrm_cmplt&av2="+dID+"&av3="+av3;
