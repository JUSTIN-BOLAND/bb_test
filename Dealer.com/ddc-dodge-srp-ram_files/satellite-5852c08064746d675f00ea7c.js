_satellite.pushAsyncScript(function(event, target, $variables){
  if(typeof DDC.dataLayer !== 'undefined'){
	...
	if(winS && winS.indexOf('_contact') >= 0){
		var dID = "unset";
		...
		var b = "https://a01.korrelate.net/a/e/d2a.ads?r="+cb+"&et=a&ago=447&ao=513&px=377&pt=s&lvl=nomodel&av1=cntct_us_cmplt&av2="+dID+"&av3="+av3;
