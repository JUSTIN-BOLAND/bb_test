_satellite.pushAsyncScript(function(event, target, $variables){
  if(typeof DDC.dataLayer !== 'undefined'){
	if(DDC.dataLayer.page.pageInfo.pageName.indexOf('FINANCE_APPLICATION') >= 0 || DDC.dataLayer.page.pageInfo.pageName.indexOf('FINANCE_LEAD') >= 0){
		var dID = "unset";
...
console.log('fired');
    ...
    var av3 = "";
		...
		var b = "https://a01.korrelate.net/a/e/d2a.ads?r="+cb+"&et=a&ago=447&ao=513&px=377&pt=s&lvl=nomodel&av1=FF_strt&av2="+dID+"&av3="+av3;
