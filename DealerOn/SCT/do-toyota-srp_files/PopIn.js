...
{AddEventListenerSafe(window,'scroll',iCoder_POP1141877261_move);}
if(!objPopIn.v.deactivateOnResizeEvent)
{AddEventListenerSafe(window,'resize',iCoder_POP1141877261_move);}}
...
{if(!elem)return;var actualHeight=objPopIn.f.getElementHeight(elem);if(actualHeight>maxHeight)
{if(!startingFontSize)
