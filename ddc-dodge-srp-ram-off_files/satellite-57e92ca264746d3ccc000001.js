_satellite.pushAsyncScript(function(event, target, $variables){
  if(typeof DDC.dataLayer !== 'undefined'){
	if(DDC.dataLayer.page.pageInfo.pageName == 'INVENTORY_FINDER_DEFAULT_AUTO'){
		var dID = "unset";
    ...
    var av3 = "";
		...
		var b = "https://a01.korrelate.net/a/e/d2a.ads?r="+cb+"&et=a&ago=447&ao=513&px=377&pt=s&lvl=nomodel&av1=CF_strt&av2="+dID+"&av3="+av3;
